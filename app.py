...
def analyze_text_meal(description: str) -> dict:
    try:
        ...
        response = client.chat.completions.create(
            model="MiniMax-M3",
            messages=[{"role": "user", "content": f"Analyze this meal: {description}. Return ONLY JSON with: description, kcal, protein, carbs, fat. Example: {"description": "example", "kcal": 350, "protein": 20, "carbs": 40, "fat": 12}}"}],
            max_tokens=300
        )
